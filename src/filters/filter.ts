...
export class FilterBuilder {
  ...
  setStartTime(start: number): FilterBuilder {
    this._start_time = start;
    return this;
  }

  setEndTime(end: number): FilterBuilder {
    this._end_time = end;
    return this;
  }
  ...
  setMinDaysFree(num_days_free: number): FilterBuilder {
    this._min_num_days_free = num_days_free;
    return this;
  }

  setSeatsLeft(seats_left: number): FilterBuilder {
    this._min_seats_left = seats_left;
    return this;
  }

  setMinHonorsCourses(min_honors_courses: number): FilterBuilder {
